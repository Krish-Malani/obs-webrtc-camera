...
export default function Home() {
  return (
    <div className="min-h-[100dvh] bg-zinc-950 text-white flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-6 sm:p-8 shadow-2xl text-center">
        ...
        <p className="text-zinc-400 mb-8">Stream a high-quality wireless webcam feed directly to OBS Studio.</p>
